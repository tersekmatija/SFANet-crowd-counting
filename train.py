...
parser.add_argument('--data_path', default=r'./data/', type=str, help='path to dataset')
parser.add_argument('--lr', default=1e-4, type=float, help='initial learning rate')
parser.add_argument('--load', default=False, action='store_true', help='load checkpoint')
parser.add_argument('--save_path', default=r'./checkpoints/SFANet', type=str, help='path to save checkpoint')
